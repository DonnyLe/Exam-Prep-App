...
test("Test generateFullSchedule", async () => {
  let res: FullSchedule = await generateFullSchedule(
    sampleExamData,
    "2024-08-21"
  );
  res.forEach((day, key) => {
    ...
    day.forEach((examsGoals) => {
      console.log("   Exam Name: " + examsGoals.studyMaterial.name);
      console.log(
        "   Goal Confidence Increase: " + examsGoals.confidenceIncrease
      );
      console.log(
        "   Exam Current Confidence: " + examsGoals.studyMaterial.confidence
      );
      console.log(
        "   Goal Confidence: " +
          ((examsGoals.studyMaterial.confidence ?? 0 ) + examsGoals.confidenceIncrease)
      );

      examsGoals.childrenConfidenceUpdates?.forEach((studyMaterialGoal) => {
        console.log(
          "      Study Material Name: " + studyMaterialGoal.studyMaterial.name
        );
        console.log(
          "      Study Material Current Confidence: " +
            studyMaterialGoal.studyMaterial.confidence
        );
        console.log(
          "      Study Material Confidence Increase: " +
            studyMaterialGoal.confidenceIncrease
